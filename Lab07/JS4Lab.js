...
//Answer:We do not want this variable to change its value.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${name} and ${friend} are having ${food} and ${drink} for lunch.`);
...
Answer:console.log(name + " and " + friend + " are having " + food + " and " + drink +" for lunch.");
console.log(`-------------------------- 
Question 2a: Oh no`)
...
//Answer:cannot reassign a value to type constant variable
 ...
 * ↓ YOUR CODE HERE ↓ */
const lunchTime = (foodChoice, drinkChoice) => `${name} and ${friend} are having ${foodChoice} and ${drinkChoice} for lunch.`;
console.log(lunchTime('Pizza','Water'));
...
//    console.log(`${name} and ${friend} are having ${foodChoice} and ${drinkChoice} for lunch.`);
// }
