...
myTable.style.border = '1px solid navy'
myTable.style.margin = '10px'
myTableRow.style.border = '1px solid navy'
myTableRow2.style.border = '1px solid navy'
...
//Answer: It is easier to control with Javascript
...
button.addEventListener('blur', () => {
   button.style.backgroundColor = `rgb(0,${Math.random() * 125},${Math.random() * 255})`
})

//Question: What other event listeners are there?
//             Try them out by replacing 'click' in your function above!
//Answer: Focus, blur, and doubleclick
