 ...
 * ↓ YOUR CODE HERE ↓ */
console.log(
  `On July 20, ${person.year}, ${person.firstname} ${person.lastname} was the first person to set foot on the Earth's moon.`);
...
let myGreeting = new Greeting('Sandra', 'VA')
myGreeting.hello()
...
let yourBook = new Book("Charlotte's Web", 'EB White');
