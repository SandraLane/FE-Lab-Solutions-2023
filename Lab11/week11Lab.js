...
/* In the HTML file, there is an image of a dog in the DIV with a class name of "dog".  You will programmatically add 2 more images, one before the dog DIV and another image after the dog DIV.
	...
	* ↓ YOUR CODE HERE ↓ */
	div = $('.dog');
	div.before("<div><img src='images/fish.png' width='200'></div>");
	div.after("<div><img src='images/cat.png' width='200'></div>");
...
/* Instructions:
	...
	let RANDOM_JOKES_API_URL = 'https://official-joke-api.appspot.com/random_joke';

	$.get(RANDOM_JOKES_API_URL, (data)=> {
		console.log(data);
...
$.get('http://localhost:3000/gradebook/9', (data) => {
